...
namespace _3esiEmployeeSystemV1.Controllers
{
    ...
    public class EmployeeTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Abbreviation")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Abbreviation")] EmployeeType employeeType)
        {
            if (ModelState.IsValid)
            {
